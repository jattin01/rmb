...
return new class extends Migration
{
    ...
    {
        Schema::create('selected_order_pump_schedules', function (Blueprint $table) {
            $table->id();
            $table->foreignId('order_id')->constrained("selected_orders")->index("os_pump_sch_order_index");
            $table->foreignId('group_company_id')->constrained("group_companies")->index("os_pump_sch_grp_index");
            $table->foreignId("user_id")->constrained()->index("os_pump_sch_user_index");
            $table->date("schedule_date");
            $table->string("order_no");
            $table->string("pump");
            $table->string("mix_code");
            $table->foreignId('cust_product_id')->nullable()->constrained("customer_products")->index("os_pump_cust_prod_index");
    ...
    {
        Schema::dropIfExists('selected_order_pump_schedules');
    }
};
