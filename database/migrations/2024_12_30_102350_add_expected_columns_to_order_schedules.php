...
class AddExpectedColumnsToOrderSchedules extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('order_schedules', function (Blueprint $table) {
            ...
            $table->integer('expected_loading_time')->nullable()->after('loading_end');
            $table->dateTime('expected_loading_start')->nullable()->after('expected_loading_time');
            $table->dateTime('expected_loading_end')->nullable()->after('expected_loading_start');

            // Add expected QC columns
            $table->integer('expected_qc_time')->nullable()->after('qc_end');
            ...
            $table->integer('expected_travel_time')->nullable()->after('travel_end');
            ...
            $table->integer('expected_insp_time')->nullable()->after('insp_end');
            ...
            $table->integer('expected_pouring_time')->nullable()->after('pouring_end');
            ...
            $table->integer('expected_cleaning_time')->nullable()->after('cleaning_end');
            ...
            $table->integer('expected_return_time')->nullable()->after('return_end');
            ...
            $table->dateTime('expected_delivery_start')->nullable()->after('delivery_start');
        });
    }
