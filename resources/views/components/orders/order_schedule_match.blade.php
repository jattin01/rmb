...
@section('content')
                        ...
                        <ul class="nav nav-tabs order-tab" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                    aria-controls="profile" aria-selected="false">Batching Plant</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                                    aria-controls="contact" aria-selected="false">Transit Mixer</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row mt-3 mt-sm-2">
                            ...
                            <div class="col-md-6 text-sm-right">
                                <span data-toggle="modal" data-target="#requirement"
                                    class="resource-requirementtext">Resource Requirement</span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box early-start"></span>
                                    Planned</span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box early"></span> Early
                                    Start </span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box delay"></span>
                                    Delayed Start</span>
                            </div>
                        </div>
                                                ...
                                                @foreach ($result['heading'] as $head_time)
                                                    <th>
                                                        <div class="inner-middle">
                                                            ...
                                                            <p class="chart-tableheadtext"> {{ $head_time['end_time'] }}
                                                            </p>
                                            ...
                                            @foreach ($result['resData'] as $res)
                                                <tr>
                                                    ...
                                                    @foreach ($res['resultData'] as $resData)
                                                        @php
                                                            $slotTime = isset($resData['slot'])
                                                                ? $resData['slot']['start_time']
                                                                : '12 AM';
                                                            ...
                                                            @if (isset($resData['id']))
                                                                ...
                                                                <div class="stip-bgmainebox">
                                                                    @foreach ($resData['stripe'] as $stripe)
                                                                        <span
                                                                            class="{{ $stripe % 2 !== 0 ? 'white-stip' : 'frist-stip' }}  @if ($slotTimeFlag) green-stip @endif"></span>
                                                                    @endforeach
                                                                </div>
                                                            @else
                                                                <div class="stip-bgmainebox">
                                                                    <span
                                                                        class="white-stip  @if ($slotTimeFlag) green-stip @endif"></span>
                                                                    <span
                                                                        class="frist-stip  @if ($slotTimeFlag) green-stip @endif"></span>
                                                                    <span
                                                                        class="white-stip  @if ($slotTimeFlag) green-stip @endif"></span>
                                                                    <span
                                                                        class="frist-stip  @if ($slotTimeFlag) green-stip @endif"></span>
                                                ...
                                                @if (isset($res['schedule']) && count($res['schedule']) > 0)
                                                    <tr class = "secound-table schedule-graph-hidden schedule-graph-{{ $res['order_no'] }}"
                                                        ...
                                                        <td colspan="8">
                                                            ...
                                                            <span class="schedule-chartvalue mr-sm-2 mr-1"> <span
                                                                    class="dots-box travelling"></span> Travelling to Site
                                                            </span>
                                                            <span class="schedule-chartvalue mr-sm-2 mr-1"> <span
                                                                    class="dots-box onsite"></span> Onsite Inspection
                                                            </span>
                                                            <span class="schedule-chartvalue mr-sm-2 mr-1"> <span
                                                                    class="dots-box bg-yellow"></span> Pump Installation
                                                            </span>
                                                            <span class="schedule-chartvalue mr-sm-2 mr-1"> <span
                                                                    ...
                                                                    @if (isset($pschResData['id']))
                                                                        ...
                                                                        <div class="stip-bgmainebox">
                                                                            @foreach ($pschResData['stripe'] as $pstripeSch)
                                                                                <span
                                                                                    class="{{ $pstripeSch % 2 !== 0 ? 'white-stip' : 'frist-stip' }} @if ($pOrderSchSlotTimeFlag) green-stip @endif"></span>
                                                                            @endforeach
                                                                        </div>
                                                                    @else
                                                                        <div class="stip-bgmainebox">
                                                                            <span
                                                                                class="white-stip @if ($pOrderSchSlotTimeFlag) green-stip @endif"></span>
                                                                            <span
                                                                                class="frist-stip @if ($pOrderSchSlotTimeFlag) green-stip @endif"></span>
                                                                            <span
                                                                                class="white-stip @if ($pOrderSchSlotTimeFlag) green-stip @endif"></span>
                                                                            <span
                                                                                class="frist-stip @if ($pOrderSchSlotTimeFlag) green-stip @endif"></span>
                                                                    ...
                                                                    @if (isset($schResData['id']))
                                                                        <div class="main-progressbox">
                                                                            <div class="progress constructions-chart ml"
                                                                                ...
                                                                                <div class="progress-bar light-green"
                                                                                    ...
                                                                                    role="progressbar"
                                                                                    style="padding : 0%; width :  {{ $schResData['return_pixels'] ? $schResData['return_pixels'] . 'px' : '0%' }}"
                                                                                    aria-valuemin="0" aria-valuemax="100">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="stip-bgmainebox">
                                                                            @foreach ($schResData['stripe'] as $stripeSch)
                                                                                <span
                                                                                    class="{{ $stripeSch % 2 !== 0 ? 'white-stip' : 'frist-stip' }} @if ($schSlotTimeFlag) green-stip @endif"></span>
                                                                            @endforeach
                                                                        </div>
                                                                    @else
                                                                        <div class="stip-bgmainebox">
                                                                            <span
                                                                                class="white-stip @if ($schSlotTimeFlag) green-stip @endif"></span>
                                                                            <span
                                                                                class="frist-stip @if ($schSlotTimeFlag) green-stip @endif"></span>
                                                                            <span
                                                                                class="white-stip @if ($schSlotTimeFlag) green-stip @endif"></span>
                                                                            <span
                                                                                class="frist-stip @if ($schSlotTimeFlag) green-stip @endif"></span>
                                                            ...
                                                            <td
                                                                ...
                                                                @if (isset($resData['id']))
                                                                    ...
                                                                    <div class="stip-bgmainebox">
                                                                        @foreach ($resData['stripe'] as $stripe)
                                                                            <span
                                                                                class="{{ $stripe % 2 !== 0 ? 'white-stip' : 'frist-stip' }} @if ($bSchSlotTimeFlag) green-stip @endif"></span>
                                                                        @endforeach
                                                                    </div>
                                                                @else
                                                                    <div class="stip-bgmainebox">
                                                                        <span
                                                                            class="white-stip @if ($bSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="frist-stip @if ($bSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="white-stip @if ($bSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="frist-stip @if ($bSchSlotTimeFlag) green-stip @endif"></span>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="row mt-3 mt-sm-2 align-items-center">
                            <div class="col-md-12 text-sm-right">
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box early-start"></span>
                                    Loading </span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box internal"></span>
                                    Internal QC </span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box travelling"></span>
                                    Travelling to Site </span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box onsite"></span>
                                ...
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box  pouring"></span>
                                    Pouring </span>
                                <br>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box cleaning"></span>
                                    Cleaning </span>
                                <span class="schedule-chartvalue mr-sm-2 mr-1"> <span class="dots-box return"></span>
                                    Return to Plant </span>
                            </div>
                        </div>
                                                            ...
                                                            <td
                                                                ...
                                                                @if (isset($resData['id']))
                                                                    ...
                                                                    <div class="stip-bgmainebox">
                                                                        @foreach ($resData['stripe'] as $stripe)
                                                                            <span
                                                                                class="{{ $stripe % 2 !== 0 ? 'white-stip' : 'frist-stip' }} @if ($tSchSlotTimeFlag) green-stip @endif"></span>
                                                                        @endforeach
                                                                    </div>
                                                                @else
                                                                    <div class="stip-bgmainebox">
                                                                        <span
                                                                            class="white-stip @if ($tSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="frist-stip @if ($tSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="white-stip @if ($tSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="frist-stip @if ($tSchSlotTimeFlag) green-stip @endif"></span>
                                                            ...
                                                            <td
                                                                ...
                                                                @if (isset($resData['id']))
                                                                    ...
                                                                    <div class="stip-bgmainebox">
                                                                        @foreach ($resData['stripe'] as $stripe)
                                                                            <span
                                                                                class="{{ $stripe % 2 !== 0 ? 'white-stip' : 'frist-stip' }} @if ($pSchSlotTimeFlag) green-stip @endif"></span>
                                                                        @endforeach
                                                                    </div>
                                                                @else
                                                                    <div class="stip-bgmainebox">
                                                                        <span
                                                                            class="white-stip @if ($pSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="frist-stip @if ($pSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="white-stip @if ($pSchSlotTimeFlag) green-stip @endif"></span>
                                                                        <span
                                                                            class="frist-stip @if ($pSchSlotTimeFlag) green-stip @endif"></span>
    ...
    <div class="modal fade filter-modal order-model" id="requirement" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            ...
                                            @foreach ($tm_resource as $tm_resource_loc => $tm_resource_val)
                                                <label class="requirementaccordion-label"> {{ $tm_resource_loc }}
                                                    ({{ $tm_resource_val->map->count()->sum() }})</label>
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body">
                                            ...
                                            @foreach ($bp_resource as $bp_resource_loc => $bp_resource_val)
                                                <label class="requirementaccordion-label">{{ $bp_resource_loc }}
                                                    ({{ $bp_resource_val->map->count()->sum() }})</label>
                                                <div class="row mt-2 mb-3">
                                            ...
                                            @foreach ($p_resource as $p_resource_loc => $p_resource_val)
                                                ...
                                                <div class="white-box">
                                                    ...
                                                    @foreach ($p_resource_val as $p_resource_type => $p_resource_type_val)
                                                        <label class="pumps-label">{{ $p_resource_type }}
                                                            ({{ $p_resource_type_val->map->count()->sum() }}) </label>
                                                        <div class="row mt-2 mb-3">
    ...
    <script>
        ...
        function redirectResources() {
            window.location.href = "{{ route('orders.schedule.step.three') }}?schedule_date=" + getQueryParam(
                'schedule_date') + "&company_id=1";
        }

        function redirectOrders() {
            window.location.href = "{{ route('orders.schedule.step.two') }}?schedule_date=" + getQueryParam(
                'schedule_date') + "&company_id=1";
        }
        ...
        function setInputsFromQueryParams() {
            ...
            int_dev_input.value = localStorage.getItem("interval_deviation") ? localStorage.getItem("interval_deviation") :
                100;
            int_dev_input_reschedule.value = localStorage.getItem("interval_deviation") ? localStorage.getItem(
