...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('update.live-schedule-order') }}" method="post">
                @csrf
                <div class="px-sm-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select id = "customers_dropdown" name = "customer_id"
                                            ...
                                            onchange = "changeDropdownOptions(this, ['projects_dropdown'], ['customer_projects'] , '/customer-projects/get/', null, ['projects_dropdown', 'projects_sites_dropdown', 'mix_codes_dropdown'])" disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select id = "projects_dropdown"disabled
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select class="form-control select-contentbox reset_from_company"
                                            id = "projects_sites_dropdown" name = "site_id" onchange = "siteOnChange(this)" disabled>
                                            <option value = "0">Select</option>
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative readonlyFieldsContainer">
                                        ...
                                        <select id = 'group_company_dropdown'
                                            class="form-control select-contentbox readonlyFields" disabled>
                                            <option value = ""></option>
                                ...
                                <div class="col-md-4">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <input type="date" name = "delivery_date"
                                            ...
                                            class="form-control user-profileinput" disabled>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="profileinput-box form-group position-relative">
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select id = 'mix_codes_dropdown' name = "id"
                                            class="form-control select-contentbox reset_from_company"
                                            onchange = "mixOnChange(this)" disabled>
                                            <option value = "0">Select</option>
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box position-relative">
                                        ...
                                        <select class="form-control select-contentbox reset_from_company"
                                            ...
                                            onchange = "structureOnChange(this)" disabled>
                                            <option value = "0">Select</option>
