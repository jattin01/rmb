            ...
            <div class="px-sm-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="col-md-8 text-sm-right">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a type="button" class="btn export-btn mr-2"
                                                href="{{ route('settings.transitMixers.export', ['search' => request('search'), 'group_company_id' => request('group_company_id')]) }}"
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <div class="row align-items-center mt-3">
                                                            <div class="col-md-6 col-4">
                                                                <a class="reset-text"
                                                                    href="{{ url('settings/transit-mixers') }}">Reset
                                                                </a>
                                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table general-table">
                                        ...
                                        <tbody>
                                            @forelse ($transitMixers as $transitMixer)
                                                <tr>
                                                    <td>{{ $transitMixer->group_company?->comp_name }}</td>
                                                    <td>{{ $transitMixer->truck_name }}</td>
                                                    <td>{{ $transitMixer->registration_no }}</td>
                                                    <td>{{ $transitMixer->driverDetail?->name }}</td>
                                                    <td>{{ $transitMixer->truck_capacity }}</td>
                                                    <td>{{ $transitMixer->description }}</td>
                                                    <td
                                                        class="{{ $transitMixer->status == 'Active' ? 'table-activetext' : 'table-inactivetext' }}">
                                                        {{ $transitMixer->status }}</td>
                                                    <td>
                                                            ...
                                                            <div class="dropdown more-drop">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('settings.transitMixers.edit', ['mixerId' => $transitMixer->id]) }}">Details</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                        ...
                        {{ $transitMixers->links('partials.pagination') }}
