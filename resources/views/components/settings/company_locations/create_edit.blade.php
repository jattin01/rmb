        ...
        <div class="px-sm-4">
            <div class="row mt-0 mt-sm-3 align-items-center justify-content-between">
                ...
                <div class="top-head">
                        <h1>Settings</h1>
                        @if(isset($location))
                        <h6><span class="active"> Location </span> <i class="fa fa-angle-right"
                ...
                <div class="col-md-3 col-4 text-right">
                    <a href="{{route('settings.companyLocations.index')}}" class="btn back-btn">Back</a>
                </div>
            </div>
            <form action="/settings/locations/store" role="post-data" method="POST" redirect="/settings/locations">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-3 mb-sm-0">
                            ...
                            <div class="profileinput-box form-group position-relative">
                                ...
                                <select class="form-control select-contentbox" id = "companies_dropdown" name="group_company_id">
                                    @foreach(@$groupCompanies as $company)
                                        <option value="{{$company->value}}" @if(@$location->group_company_id == $company->value) selected @endif>{{$company->label}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="profileinput-box  position-relative mt-3">
                                ...
                                <textarea class="form-control user-profileinput" name="address" id="address" placeholder="Enter Address" rows="5" >{{@$location->address}}</textarea>
                            </div>
