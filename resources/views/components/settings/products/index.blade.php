                                    ...
                                    <div class="col-md-8 text-sm-right">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a type="button" class="btn export-btn mr-2"
                                                href="{{ route('settings.product.mix.export', ['search' => request('search'), 'group_company_id' => request('group_company_id')]) }}"
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <div class="row align-items-center mt-3">
                                                            <div class="col-md-6 col-4">
                                                                <a class="reset-text"
                                                                    href="{{ url('settings/products') }}">Reset
                                                                </a>
                                                            </div>
                                            ...
                                            <table class="table general-table">
                                                ...
                                                <tbody>
                                                    @foreach (@$products as $product)
                                                        <tr>
                                                            <td>{{ $product->group_company?->comp_name }}</td>
                                                            {{-- <td>
                                                                @foreach ($product->structuralReferences as $key => $reference)
                                                                @if ($key == 0)
                                                                    {{ $reference->structural->name ?? 'N/A' }}
                                                                @else
                                                                    ,{{ $reference->structural->name ?? 'N/A' }}
                                                                @endif
                                                            @endforeach
                                                            ...
                                                            <td>{{ $product->usage }}</td>
                                                            {{-- <td>{{ $product->batching_creation_time }}</td>
                                                            <td>{{ $product->temperature_creation_time }}</td> --}}
                                                            <td
                                                                    ...
                                                                    <div class="dropdown more-drop">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('settings.products.edit', ['productId' => $product->id]) }}">Details</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
