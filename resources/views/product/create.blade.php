...
<section class="content">
    <div class="container-fluid">
        <div class="px-sm-4">
            <form action="/products/store" role="post-data" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-3 col-8 mb-sm-0 mb-2">
                        <div class="top-head">
                            ...
                            <h6><span class="active"> Mix Overview </span> <i class="fa fa-angle-right"
                                    aria-hidden="true"></i> Edit Product </h6>
                            @else
                            <h6><span class="active"> Mix Overview </span> <i class="fa fa-angle-right"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select class="form-control select-contentbox" name="product_type_id">
                                            <option value="">Select</option>
                                            @foreach($productTypes as $type)
                                            <option value="{{$type->id}}" @if(isset($product) && ($product->product_type_id == $type->id)) selected @endif>{{$type->type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <input type="text" name="density" value="{{@$product->density}}" class="form-control user-profileinput" placeholder="Enter">
                                    </div>
                                </div>
                                        ...
                                        @if(isset($product) && $product->productContents)
                                            ...
                                            <tr>
                                                ...
                                                <td width="120px" class="gray-text">
                                                    <a href="#" onclick="editProductContent({{$content->id}})" class="table-edittext"> Edit </a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        @endif
...
<div class="modal fade filter-modal full-heightmodal" id="user-profile" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/products/content/store" role="post-data" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="profileinput-box mt-4 form-group position-relative">
                            ...
                            <input type="text" name="quantity" class="form-control user-profileinput padding-right">
                        </div>
