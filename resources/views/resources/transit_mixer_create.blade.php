    ...
    <div class="container-fluid">
        <div class="px-sm-4">
            ...
            <div class="batching-plantaddbox mt-sm-4 mt-3">
                <form action="/resources/transit-mixer-store" role="post-data" method="POST">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select class="form-control select-contentbox" name="driver_code" onchange="setDriver(this)">
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <input type="text" name="capacity" value="{{@$mixerDetails->truck_capacity}}" class="form-control user-profileinput" placeholder="Enter">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
