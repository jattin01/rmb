    ...
    <div class="container-fluid">
        ...
        <div class="px-sm-4">
            ...
            <div class="batching-plantaddbox mt-sm-4 mt-3">
                <form action="/resources/pump-store" role="post-data" method="POST">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        <label class="selext-label">Pump Code</label>
                                ...
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <select class="form-control select-contentbox" name="type">
                                            ...
                                            <option value="{{$type->type}}" @if(@$pumpDetails->type == $type->type) selected @endif> {{$type->type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="profileinput-box form-group position-relative">
                                        ...
                                        <input type="text" name="pump_capacity" value="{{@$pumpDetails->pump_capacity}}" class="form-control user-profileinput" placeholder="Enter">
                                    </div>
                                </div>
